...
import sigmaone.industrialism.block.multiblock.machine.BlockEntityTestMultiblockRenderer;
...
public class IndustrialismClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Industrialism.MULTIBLOCK_CHILD_BLOCK, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(Industrialism.TEST_MULTIBLOCK_BLOCK, RenderLayer.getCutout());
		...
		BlockEntityRendererRegistry.INSTANCE.register(Industrialism.TEST_MULTIBLOCK, BlockEntityTestMultiblockRenderer::new);
	}
}
