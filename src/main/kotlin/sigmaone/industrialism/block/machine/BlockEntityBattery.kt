...
class BlockEntityBattery : BlockEntityConnectableEnergyContainer(Industrialism.BATTERY, 16000.toDouble(), EnergyTier.LOW, sideConfig), IConfigurable {
    companion object {
        val sideConfig: HashMap<Direction, InputConfig> = hashMapOf(
