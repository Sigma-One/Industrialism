...
class BlockEntityManualGenerator : BlockEntityConnectableEnergyContainer(Industrialism.MANUAL_GENERATOR, 500f.toDouble(), EnergyTier.LOW, sideConfig) {
    companion object {
        var sideConfig: HashMap<Direction, InputConfig> = hashMapOf(
